...
function Hospitalization() {
  ...
  const sendCheckup = () => {
    let datum =
      ...
      form.values.date.getFullYear();
    axios
      .post("http://localhost:3000/hospitalization/postCheckup", {
        description: form.values.description,
        id_employee: form.values.id_employee,
        id_patient: form.values.id_patient,
        date: datum,
          ...
          >
            <fieldset className="pt-0 m-auto">
              <p className="pb-8">
                ...
                />
                <label htmlFor="Sprava" className="pr-6 pl-1 font-bold">
                  Správa
                </label>
                ...
                />
                <label htmlFor="Diagnoza" className="pr-6 pl-1 font-bold">
                  Diagnóza
                </label>
                ...
                />
                <label htmlFor="vysetrenie" className="pr-6 pl-1 font-bold">
                  Vyšetrenie
                </label>
                ...
                />
                <label htmlFor="alergia" className="pr-6 pl-1 font-bold">
                  Alergia
                </label>
              </p>
            </fieldset>
